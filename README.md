...
-   06.15
    -   로그아웃 모달창 생성(진석)
    -   로그인시 로그아웃 , 정보수정 버튼 두개생성 오류 수정 (진석)

<hr>

-   06.14
    -   메인페이지 리뷰도 id 값 대신 이름으로 가져옴 (하늘이)
    -   상단 Navbar.jsx 반응형 구현 및 페이지 작아지면 햄버거버튼으로 드롭다운 메뉴생성 -> 로그인, 회원가입 가능(진석)

<hr>

-   06.12

    -   리뷰페이지 정렬순 , 평점순 , 별점순 , 장르별 리뷰 기능 구현 완료 (하늘이)
    -   커뮤니티 페이지 댓글 , 답글 기능 구현 완료 (하늘이)
